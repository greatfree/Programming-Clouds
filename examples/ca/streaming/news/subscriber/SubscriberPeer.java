...
{
	private Peer<NewsSubscriberDispatcher> peer;
	...
	{
		this.peer = new Peer.PeerBuilder<NewsSubscriberDispatcher>()
				...
				.dispatcher(new NewsSubscriberDispatcher(RegistryConfig.DISPATCHER_THREAD_POOL_SIZE, RegistryConfig.DISPATCHER_THREAD_POOL_KEEP_ALIVE_TIME, RegistryConfig.SCHEDULER_THREAD_POOL_SIZE, RegistryConfig.SCHEDULER_THREAD_POOL_KEEP_ALIVE_TIME))
