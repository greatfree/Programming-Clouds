...
class ServiceAccessor
{
	...
	public boolean isVideoExisted(String keyword) throws ClassNotFoundException, RemoteReadException, IOException
	{
		return ((IsVideoExistedResponse)this.client.read(this.subscriberAddress.getIP(), this.subscriberAddress.getPort(), new IsVideoExistedRequest(keyword))).isExisted();
	}
	
	public byte[] searchVideo(String keyword, int index) throws ClassNotFoundException, RemoteReadException, IOException
	{
		return ((VideoSearchResponse)this.client.read(this.subscriberAddress.getIP(), this.subscriberAddress.getPort(), new VideoSearchRequest(keyword, index))).getVideoPiece();
	}
