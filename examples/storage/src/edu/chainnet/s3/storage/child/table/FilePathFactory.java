...
class FilePathFactory implements CacheMapFactorable<String, FilePath>
{
	...
	public PersistentCacheManager createManagerInstance(String rootPath, String cacheKey, long cacheSize, int offheapSizeInMB, int diskSizeInMB)
	{
		return CacheManagerBuilder.newCacheManagerBuilder()
				...
				.withCache(cacheKey, CacheConfigurationBuilder.newCacheConfigurationBuilder(String.class, FilePath.class, ResourcePoolsBuilder.newResourcePoolsBuilder()
	...
	@Override
	public Cache<String, FilePath> createCache(PersistentCacheManager manager, String cacheKey)
	{
		return manager.getCache(cacheKey, String.class, FilePath.class);
	}
