...
class StoragePathsFactory implements CacheMapFactorable<String, StoragePaths>
{
	...
	public PersistentCacheManager createManagerInstance(String rootPath, String cacheKey, long cacheSize, int offheapSizeInMB, int diskSizeInMB)
	{
		return CacheManagerBuilder.newCacheManagerBuilder()
				...
				.withCache(cacheKey, CacheConfigurationBuilder.newCacheConfigurationBuilder(String.class, StoragePaths.class, ResourcePoolsBuilder.newResourcePoolsBuilder()
	...
	@Override
	public Cache<String, StoragePaths> createCache(PersistentCacheManager manager, String cacheKey)
	{
		return manager.getCache(cacheKey, String.class, StoragePaths.class);
	}
