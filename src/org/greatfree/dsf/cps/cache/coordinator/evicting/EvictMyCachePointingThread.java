...
public class EvictMyCachePointingThread extends NotificationObjectQueue<EvictedNotification<MyCachePointing>>
{

	public EvictMyCachePointingThread(int taskSize)
	{
		super(taskSize);
	}
	...
	public void run()
	{
		EvictedNotification<MyCachePointing> notification;
