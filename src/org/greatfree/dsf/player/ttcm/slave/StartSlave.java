package org.greatfree.dsf.player.ttcm.slave;
...
import org.greatfree.dsf.threading.PingTask;
import org.greatfree.dsf.threading.PongTask;
...
//		PlayerSystem.THREADING().startSlave(ThreadConfig.SLAVE, ThreadConfig.THREAD_PORT, ThreadConfig.MASTER);
		...
		PlayerSystem.THREADING().addTask(new PingTask());
		PlayerSystem.THREADING().addTask(new PongTask());
