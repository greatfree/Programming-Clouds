package org.greatfree.dsf.player.tr.slave;
...
import org.greatfree.dsf.threading.AddTask;
import org.greatfree.dsf.threading.MultiplyTask;
...
//		PlayerSystem.THREADING().startSlave(ThreadConfig.SLAVE, ThreadConfig.THREAD_PORT, ThreadConfig.MASTER);
		...
		PlayerSystem.THREADING().addTask(new AddTask());
		PlayerSystem.THREADING().addTask(new MultiplyTask());
