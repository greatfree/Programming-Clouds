package org.greatfree.dsf.streaming.broadcast.client;
	...
	public static void main(String[] args) throws ClassNotFoundException, RemoteReadException, IOException, InterruptedException
	{
		...
		do
		{
			if (option.equals("n"))
			{
				...
				topic = in.nextLine();
				ServiceAccessor.BROAD().setSubscriberAddress(publisher, topic);
			}
			
			System.out.println("Search query:");
			query = in.nextLine();
			
			List<String> results = ServiceAccessor.BROAD().search(query);
