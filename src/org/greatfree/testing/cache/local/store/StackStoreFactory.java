...
class StackStoreFactory implements CacheMapFactorable<String, MyStackObj>
{
	...
	public PersistentCacheManager createManagerInstance(String rootPath, String cacheKey, long cacheSize, int offheapSizeInMB, int diskSizeInMB)
	{
		return CacheManagerBuilder.newCacheManagerBuilder()
				...
				.withCache(cacheKey, CacheConfigurationBuilder.newCacheConfigurationBuilder(String.class, MyStackObj.class, ResourcePoolsBuilder.newResourcePoolsBuilder()
	...
	@Override
	public Cache<String, MyStackObj> createCache(PersistentCacheManager manager, String cacheKey)
	{
		return manager.getCache(cacheKey, String.class, MyStackObj.class);
	}
