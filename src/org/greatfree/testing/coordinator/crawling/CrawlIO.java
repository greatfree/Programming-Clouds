...
//	public CrawlIO(Socket clientSocket, Sync collaborator, int remoteServerPort)
	public CrawlIO(Socket clientSocket, Sync collaborator)
	{
	...
	public void run()
	{
		...
		while (!super.isShutdown())
		{
			try
			{
				...
				CoordinatorMessageProducer.SERVER().produceCrawlingMessage(new MessageStream<ServerMessage>(super.getOutStream(), super.getLock(), message));
			}
