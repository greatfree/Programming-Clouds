...
public class UnicastRequestThread extends BoundRequestQueue<UnicastRequest, UnicastResponse, MulticastMessageDisposer<UnicastRequest>>
{
	/*
	 * Initialize the thread. The binder is assigned at this point. 11/29/2014, Bing Li
	 */
	public UnicastRequestThread(IPResource ipPort, FreeClientPool pool, int taskSize, String dispatcherKey, MulticastMessageDisposer<UnicastRequest> reqBinder)
	{
