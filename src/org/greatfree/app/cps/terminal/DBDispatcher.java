...
public class DBDispatcher extends ServerDispatcher<ServerMessage>
{
	private NotificationDispatcher<OrderNotification, OrderNotificationDBThread, OrderNotificationDBThreadCreator> notificationDispatcher;
	private RequestDispatcher<MerchandiseRequest, MerchandiseStream, MerchandiseResponse, MerchandiseRequestDBThread, MerchandiseRequestDBThreadCreator> requestDispatcher;

//	public DBDispatcher(int schedulerPoolSize, long schedulerKeepAliveTime)
	public DBDispatcher(int threadPoolSize, long threadKeepAliveTime, int schedulerPoolSize, long schedulerKeepAliveTime)
	{
		super(threadPoolSize, threadKeepAliveTime, schedulerPoolSize, schedulerKeepAliveTime);
//		super(schedulerPoolSize, schedulerKeepAliveTime);

		this.notificationDispatcher = new NotificationDispatcher.NotificationDispatcherBuilder<OrderNotification, OrderNotificationDBThread, OrderNotificationDBThreadCreator>()
				.poolSize(ServerConfig.NOTIFICATION_DISPATCHER_POOL_SIZE)
				.threadCreator(new OrderNotificationDBThreadCreator())
		...
		this.requestDispatcher = new RequestDispatcher.RequestDispatcherBuilder<MerchandiseRequest, MerchandiseStream, MerchandiseResponse, MerchandiseRequestDBThread, MerchandiseRequestDBThreadCreator>()
				.poolSize(ServerConfig.REQUEST_DISPATCHER_POOL_SIZE)
				.threadCreator(new MerchandiseRequestDBThreadCreator())
