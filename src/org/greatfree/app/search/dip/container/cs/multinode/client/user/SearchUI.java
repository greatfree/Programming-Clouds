...
import org.greatfree.app.search.dip.cs.multinode.client.user.SearchMenu;
import org.greatfree.app.search.dip.cs.multinode.client.user.SearchOptions;
	...
	public void send(int option) throws ClassNotFoundException, RemoteReadException, IOException
	{
		...
		switch (option)
		{
			case SearchOptions.TYPE_QUERY:
				...
				response = (Response)StandaloneClusterClient.CONTAINER().readRoot(new SearchMultiRequest("greatfree", keyword));
