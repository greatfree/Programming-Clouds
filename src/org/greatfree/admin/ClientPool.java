...
/*
 * The pool is responsible for creating and managing instance of FreeClient to achieve the goal of using a small number of instances of FreeClient to send messages to the coordinator in a high performance. 11/27/2014, Bing Li
 */
