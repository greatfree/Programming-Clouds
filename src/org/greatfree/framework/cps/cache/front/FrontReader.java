...
//		return (FrontResponse)(RemoteReader.REMOTE().read(NodeID.DISTRIBUTED().getKey(), ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new FrontRequest(query)));
	...
	{
		return (LoadMyDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadMyDataRequest(myDataKey)));
	}
	...
	{
		return (LoadMyDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadMyDataRequest(mapKey, myDataKey)));
	}
	...
	{
		return (LoadMyDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadMyDataRequest(myDataKey, true)));
	}
	...
	{
		return (LoadMyDataByKeysResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadMyDataByKeysRequest(keys)));
	}
	...
	{
		return (LoadMyDataByKeysResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadMyDataByKeysRequest(mapKey, keys)));
	}
	...
	{
		return (LoadMyDataByKeysResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadMyDataByKeysRequest(keys, true)));
	}
	...
	{
		return (LoadMyPointingResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadMyPointingRequest(index)));
	}
	...
	{
		return (LoadTopMyPointingsResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadTopMyPointingsRequest(endIndex)));
	}
	...
	{
		return (LoadRangeMyPointingsResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadRangeMyPointingsRequest(startIndex, endIndex)));
	}
	...
	{
		return (LoadMyPointingMapResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadMyPointingMapRequest(key)));
	}
	...
	{
		return (LoadMaxMyPointingResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadMaxMyPointingRequest()));
	}
	...
	{
		return (LoadMinMyPointingResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadMinMyPointingRequest()));
	}
	...
	{
		return (ContainsKeyOfCachePointingResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new ContainsKeyOfCachePointingRequest(mapKey, resourceKey, false)));
	}
	...
	{
		return (ContainsKeyOfCachePointingResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new ContainsKeyOfCachePointingRequest(mapKey, resourceKey, true)));
	}
	...
	{
		return (MaxCachePointingResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new MaxCachePointingRequest(mapKey, false)));
	}
	...
	{
		return (MaxCachePointingResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new MaxCachePointingRequest(mapKey, true)));
	}
	...
	{
		return (CachePointingByKeyResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new CachePointingByKeyRequest(mapKey, resourceKey, false)));
	}
	...
	{
		return (CachePointingByKeyResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new CachePointingByKeyRequest(mapKey, resourceKey, true)));
	}
	...
	{
		return (IsCacheExistedInPointingStoreResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new IsCacheExistedInPointingStoreRequest(mapKey, false)));
	}
	...
	{
		return (IsCacheExistedInPointingStoreResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new IsCacheExistedInPointingStoreRequest(mapKey, true)));
	}
	...
	{
		return (IsCacheEmptyInPointingStoreResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new IsCacheEmptyInPointingStoreRequest(mapKey, false)));
	}
	...
	{
		return (IsCacheEmptyInPointingStoreResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new IsCacheEmptyInPointingStoreRequest(mapKey, true)));
	}
	...
	{
		return (CachePointingByIndexResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new CachePointingByIndexRequest(mapKey, index, false)));
	}
	...
	{
		return (CachePointingByIndexResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new CachePointingByIndexRequest(mapKey, index, true)));
	}
	...
	{
		return (TopCachePointingsResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new TopCachePointingsRequest(mapKey, endIndex, false)));
	}
	...
	{
		return (TopCachePointingsResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new TopCachePointingsRequest(mapKey, endIndex, true)));
	}
	...
	{
		return (RangeCachePointingsResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new RangeCachePointingsRequest(mapKey, startIndex, endIndex, false)));
	}
	...
	{
		return (RangeCachePointingsResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new RangeCachePointingsRequest(mapKey, startIndex, endIndex, true)));
	}
	...
	{
		return (PointingByIndexPrefetchListResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PointingByIndexPrefetchListRequest(listKey, index)));
	}
	...
	{
		return (TopPointingsPrefetchListResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new TopPointingsPrefetchListRequest(listKey, endIndex)));
	}
	...
	{
		return (RangePointingsPrefetchListResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new RangePointingsPrefetchListRequest(listKey, startIndex, endIndex)));
	}
	...
	{
		return (IsCacheReadExistedInPointingStoreResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new IsCacheReadExistedInPointingStoreRequest(mapKey)));
	}
	...
	{
		return (TopReadCachePointingsResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new TopReadCachePointingsRequest(mapKey, endIndex)));
	}
	...
	{
		return (RangeReadCachePointingsResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new RangeReadCachePointingsRequest(mapKey, startIndex, endIndex)));
	}
	...
	{
		return (PopSingleMyStoreDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PopSingleMyStoreDataRequest(stackKey, false)));
	}
	...
	{
		return (PopSingleMyStoreDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PopSingleMyStoreDataRequest(stackKey, true)));
	}
...
//		return (PopMyStoreDataResponse)(RemoteReader.REMOTE().read(NodeID.DISTRIBUTED().getKey(), ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PopMyStoreDataRequest(stackKey, count, false, false)));
		return (PopMyStoreDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PopMyStoreDataRequest(stackKey, count, false, false)));
	}
...
//		return (PopMyStoreDataResponse)(RemoteReader.REMOTE().read(NodeID.DISTRIBUTED().getKey(), ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PopMyStoreDataRequest(stackKey, count, true, false)));
		return (PopMyStoreDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PopMyStoreDataRequest(stackKey, count, true, false)));
	}
	...
	{
		return (PeekSingleMyStoreDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PeekSingleMyStoreDataRequest(stackKey, true)));
	}
	...
	{
		return (PeekMyStoreDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PeekMyStoreDataRequest(stackKey, count, false)));
	}
	...
	{
		return (PeekMyStoreDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PeekMyStoreDataRequest(stackKey, startIndex, endIndex, false)));
	}
	...
	{
		return (PeekMyStoreDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PeekMyStoreDataRequest(stackKey, false, index)));
	}
	...
	{
		return (PeekMyStoreDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PeekMyStoreDataRequest(stackKey, count, true)));
	}
	...
	{
		return (PeekMyStoreDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PeekMyStoreDataRequest(stackKey, startIndex, endIndex, true)));
	}
	...
	{
		return (PeekMyStoreDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PeekMyStoreDataRequest(stackKey, true, index)));
	}
	...
	{
		return (DequeueSingleMyStoreDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new DequeueSingleMyStoreDataRequest(queueKey)));
	}
	...
	{
		return (DequeueMyStoreDataResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new DequeueMyStoreDataRequest(queueStack, count, false)));
	}
	...
	{
		return (PeekSingleMyStoreDataQueueResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PeekSingleMyStoreDataQueueRequest(queueKey)));
	}
	...
	{
		return (PeekMyStoreDataQueueResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PeekMyStoreDataQueueRequest(queueKey, count)));
	}
	...
	{
		return (PeekMyStoreDataQueueResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PeekMyStoreDataQueueRequest(queueKey, startIndex, endIndex)));
	}
	...
	{
		return (PeekMyStoreDataQueueResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new PeekMyStoreDataQueueRequest(startIndex, queueKey)));
	}
	...
	{
		return (LoadMapStoreDataKeysResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadMapStoreDataKeysRequest(mapKey)));
	}
	...
	{
		return (LoadMyUKResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadMyUKRequest(index)));
	}
	...
	{
		return (LoadTopMyUKsResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadTopMyUKsRequest(endIndex)));
	}
	...
	{
		return (LoadRangeMyUKsResponse)(RemoteReader.REMOTE().read(ServerConfig.COORDINATOR_ADDRESS, ServerConfig.COORDINATOR_PORT, new LoadRangeMyUKsRequest(startIndex, endIndex)));
	}
}
