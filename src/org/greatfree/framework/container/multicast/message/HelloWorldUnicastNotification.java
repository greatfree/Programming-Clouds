...
public class HelloWorldUnicastNotification extends ClusterNotification
{
	...
	{
		super(MulticastMessageType.UNICAST_NOTIFICATION, MultiAppID.HELLO_WORLD_UNICAST_NOTIFICATION);
		this.hl = hl;
	}
