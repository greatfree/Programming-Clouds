 ...
 *
 */
final class StartDisabledPeerAsClient
{
	...
	{
		UnaryDisabledPeer.CS().start(Config.FRIEND_A, new DServerTask(), true, Config.WAIT_TIME);
		System.out.println("Say someting to " + Config.FRIEND_B + " as notifications");
		...
		System.out.println("Say someting to " + Config.FRIEND_B + " as requests");
