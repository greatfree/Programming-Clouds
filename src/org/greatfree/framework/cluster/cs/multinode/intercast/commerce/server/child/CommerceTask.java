...
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.CommerceApplicationID;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.CustomerRegistryRequest;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.CustomerRegistryResponse;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.CustomerSignInRequest;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.CustomerSignInResponse;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.CustomerSignOutRequest;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.CustomerSignOutResponse;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.FollowMerchandiseNotification;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.FollowVendorNotification;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.InterFollowMerchandiseNotification;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.InterFollowVendorNotification;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.OpenShopRequest;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.PollMerchandiseRequest;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.PollMerchandiseResponse;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.PollVendorRequest;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.PollVendorResponse;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.VendorRegistryRequest;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.VendorRegistryResponse;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.VendorSignInRequest;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.VendorSignInResponse;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.VendorSignOutRequest;
import org.greatfree.framework.cluster.cs.multinode.intercast.commerce.message.VendorSignOutResponse;
