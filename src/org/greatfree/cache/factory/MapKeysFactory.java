...
class MapKeysFactory implements PersistableMapFactorable<String, MapKeys>
{
	...
	public PersistentCacheManager createManagerInstance(String rootPath, String cacheKey, long cacheSize, long offheapSizeInMB, long diskSizeInMB)
	{
		return CacheManagerBuilder.newCacheManagerBuilder()
				...
				.withCache(cacheKey, CacheConfigurationBuilder.newCacheConfigurationBuilder(String.class, MapKeys.class, ResourcePoolsBuilder.newResourcePoolsBuilder()
	...
	@Override
	public Cache<String, MapKeys> createCache(PersistentCacheManager manager, String cacheKey)
	{
		return manager.getCache(cacheKey, String.class, MapKeys.class);
	}
