...
class ChildMulticastReader<Request extends MulticastRequest>
{
	...
	private SyncRemoteEventer<Request> eventer;
	...
	public ChildMulticastReader(String localIPKey, SyncRemoteEventer<Request> eventer, int treeBranchCount)
	{
