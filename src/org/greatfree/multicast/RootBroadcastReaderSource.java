...
public abstract class RootBroadcastReaderSource<Source extends Serializable, BroadcastRequestMessage extends BroadcastRequest, MessageCreator extends RootBroadcastRequestCreatable<BroadcastRequestMessage, Source>>
{
	 ...
	 */
	public RootBroadcastReaderSource(FreeClientPool clientPool, int rootBranchCount, int treeBranchCount, MessageCreator creator, long waitTime)
	{
