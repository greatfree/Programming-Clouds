...
public class DistributedChildMapListener implements CacheEventListener<String, CacheValue>
{
	private ChildMapDistributable cache;
	
	public DistributedChildMapListener(ChildMapDistributable cache)
	{
		this.cache = cache;
	}
