...
public class CacheNotificationDispatcher<Notification extends OldMulticastMessage, NotificationThread extends NotificationQueue<Notification>, Key extends CacheKey<String>, Value extends CacheKey<String>, Factory extends PersistableMapFactorable<String, Value>, DB extends KeyLoadable<String>, ThreadCreator extends CacheNotificationThreadCreatable<Notification, NotificationThread, Key, Value, Factory, DB>> extends ConcurrentDispatcher
{
...
//	private Map<String, NotificationThread> threads;
	...
	private ThreadIdleChecker<CacheNotificationDispatcher<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator>> idleChecker;
	// The registry that retains all of the instances of the distributed maps on a child of a cluster. 07/16/2017, Bing Li
	private ChildMapRegistry<Key, Value, Factory, DB> registry;

	/*
	public CacheNotificationDispatcher(ThreadPool threadPool, ThreadCreator threadCreator, int maxTaskSize, int poolSize, ScheduledThreadPoolExecutor scheduler, long dispatcherWaitTime, boolean isSelfThreadPool, long idleCheckDelay, long idleCheckPeriod, int waitRound, ChildMapRegistry<Key, Value, Factory, DB> registry, long timeout)
	{
		super(threadPool, maxTaskSize, poolSize, scheduler, dispatcherWaitTime, isSelfThreadPool, idleCheckDelay, idleCheckPeriod, waitRound, timeout);
		...
		this.idleChecker = new ThreadIdleChecker<CacheNotificationDispatcher<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator>>(this);
		this.registry = registry;
	}
	*/

	public CacheNotificationDispatcher(CacheNotificationDispatcherBuilder<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator> builder)
	{
...
//		super(builder.getPoolSize(), builder.getNotificationQueueSize(), builder.getScheduler(), builder.getDispatcherWaitTime(), builder.getIdleCheckDelay(), builder.getIdleCheckPeriod(), builder.getWaitRound());
	...
	public static class CacheNotificationDispatcherBuilder<Notification extends OldMulticastMessage, NotificationThread extends NotificationQueue<Notification>, Key extends CacheKey<String>, Value extends CacheKey<String>, Factory extends PersistableMapFactorable<String, Value>, DB extends KeyLoadable<String>, ThreadCreator extends CacheNotificationThreadCreatable<Notification, NotificationThread, Key, Value, Factory, DB>> implements Builder<CacheNotificationDispatcher<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator>>
	{
...
//		private long timeout;
		...
		public CacheNotificationDispatcherBuilder()
		{
		}

		public CacheNotificationDispatcherBuilder<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator> poolSize(int poolSize)
		{
		...
		/*
		public CacheNotificationDispatcherBuilder<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator> keepAliveTime(long keepAliveTime)
		{
			this.keepAliveTime = keepAliveTime;
			return this;
		}

		public CacheNotificationDispatcherBuilder<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator> threadPool(ThreadPool threadPool)
		{
		...
		*/
		...
		public CacheNotificationDispatcherBuilder<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator> threadCreator(ThreadCreator threadCreator)
		{
			this.threadCreator = threadCreator;
			return this;
		}
		
		public CacheNotificationDispatcherBuilder<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator> notificationQueueSize(int nqSize)
		{
			this.notificationQueueSize = nqSize;
			return this;
		}

		public CacheNotificationDispatcherBuilder<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator> dispatcherWaitTime(long dispatcherWaitTime)
		{
		...
		/*
		public CacheNotificationDispatcherBuilder<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator> waitRound(int waitRound)
		{
		...
		*/
		...
		public CacheNotificationDispatcherBuilder<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator> idleCheckDelay(long idleCheckDelay)
		{
			this.idleCheckDelay = idleCheckDelay;
			return this;
		}

		public CacheNotificationDispatcherBuilder<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator> idleCheckPeriod(long idleCheckPeriod)
		{
			this.idleCheckPeriod = idleCheckPeriod;
			return this;
		}

		public CacheNotificationDispatcherBuilder<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator> scheduler(ScheduledThreadPoolExecutor scheduler)
		{
			this.scheduler = scheduler;
			return this;
		}

		public CacheNotificationDispatcherBuilder<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator> registry(ChildMapRegistry<Key, Value, Factory, DB> registry)
		{
			this.registry = registry;
			return this;
		}
		...
		/*
		public CacheNotificationDispatcherBuilder<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator> timeout(long timeout)
		{
		...
		*/
		...
		@Override
		public CacheNotificationDispatcher<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator> build()
		{
			return new CacheNotificationDispatcher<Notification, NotificationThread, Key, Value, Factory, DB, ThreadCreator>(this);
		}
		...
		*/
		...
		public ChildMapRegistry<Key, Value, Factory, DB> getRegistry()
		{
...
//	private synchronized boolean createThread(Notification notification, int upperSize)
	private synchronized boolean createThread(int upperSize)
	{
		...
		if (this.threads.size() < upperSize)
		{
			...
			NotificationThread thread = this.threadCreator.createNotificationThreadInstance(this.getMaxTaskSizePerThread(), this.registry);
			// Take the notification. 11/29/2014, Bing Li
			thread.enqueue(this.notificationQueue.poll());
			// Initialize one instance of the Runner. 05/19/2018, Bing Li
