...
//	private boolean isForwarded;
	...
	// The reason to place a map here is due to the fact that it is possible that one child has multiple application-delve destination keys resided. 03/14/2019, Bing Li
