...
public abstract class ATMNotification extends Notification
{
...
//	private String instructKey;
	...
	*/
	...
	public ATMNotification(String threadKey, int instruction)
	{
		super(instruction);
...
//		this.instructKey = Tools.generateUniqueKey();
	...
	public ATMNotification(Set<String> threadKeys, int instruction)
	{
		super(instruction);
		this.threadKey = ThreadConfig.NO_THREAD_KEY;
