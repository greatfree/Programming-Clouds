...
// public class AnycastRequestDispatcher<Request extends AnycastRequest, Response extends AnycastResponse, RequestThread extends AnycastRequestQueue<Request, Response>, RequestThreadCreator extends AnycastRequestThreadCreatable<Request, Response, RequestThread>> extends ConcurrentDispatcher implements Runnable, CheckIdleable
public class AnycastRequestDispatcher<Request extends AnycastRequest, Response extends AnycastResponse, RequestThread extends AnycastRequestQueue<Request, Response>, RequestThreadCreator extends AnycastRequestThreadCreatable<Request, Response, RequestThread>> extends ConcurrentDispatcher
{
	// Declare a map to contain all of the threads. 11/29/2014, Bing Li
//	private Map<String, RequestThread> threads;
	 ...
	 */
	/*
	public AnycastRequestDispatcher(FreeClientPool pool, String serverAddress, int serverPort, int poolSize, long keepAliveTime, RequestThreadCreator threadCreator, int maxTaskSize, int maxThreadSize, long dispatcherWaitTime, int waitRound, long idleCheckDelay, long idleCheckPeriod, ScheduledThreadPoolExecutor scheduler, long timeout)
	{
	...
	*/
	 ...
	 */
	/*
	public AnycastRequestDispatcher(FreeClientPool pool, String serverAddress, int serverPort, ThreadPool threadPool, RequestThreadCreator threadCreator, int maxTaskSize, int maxThreadSize, long dispatcherWaitTime, int waitRound, long idleCheckDelay, long idleCheckPeriod, ScheduledThreadPoolExecutor scheduler, long timeout)
	{
...
//		super(threadPool, maxTaskSize, maxThreadSize, scheduler, dispatcherWaitTime, idleCheckDelay, idleCheckPeriod, waitRound);
		this.pool = pool;
		this.serverAddress = new IPPort(serverAddress, serverPort);
		this.threads = new ConcurrentHashMap<String, RequestThread>();
		this.requestQueue = new LinkedBlockingQueue<Request>();
	...
	*/
	...
	public AnycastRequestDispatcher(AnycastRequestDispatcherBuilder<Request, Response, RequestThread, RequestThreadCreator> builder)
	{
...
//		super(builder.getThreadPool(), builder.getMaxTaskSize(), builder.getScheduler(), builder.getDispatcherWaitTime(), builder.getIdleCheckDelay(), builder.getIdleCheckPeriod(), builder.getWaitRound());
	...
	public static class AnycastRequestDispatcherBuilder<Request extends AnycastRequest, Response extends AnycastResponse, RequestThread extends AnycastRequestQueue<Request, Response>, RequestThreadCreator extends AnycastRequestThreadCreatable<Request, Response, RequestThread>> implements Builder<AnycastRequestDispatcher<Request, Response, RequestThread, RequestThreadCreator>>
	{
...
//		private long timeout;
		...
		public AnycastRequestDispatcherBuilder()
		{
		}

		/*
		public AnycastRequestDispatcherBuilder<Request, Response, RequestThread, RequestThreadCreator> threadPool(ThreadPool threadPool)
		{
		...
		*/
		...
		public AnycastRequestDispatcherBuilder<Request, Response, RequestThread, RequestThreadCreator> poolSize(int poolSize)
		{
		...
		/*
		public AnycastRequestDispatcherBuilder<Request, Response, RequestThread, RequestThreadCreator> keepAliveTime(long keepAliveTime)
		{
		...
		*/
		...
		public AnycastRequestDispatcherBuilder<Request, Response, RequestThread, RequestThreadCreator> maxTaskSize(int maxTaskSize)
		{
		...
		/*
		public AnycastRequestDispatcherBuilder<Request, Response, RequestThread, RequestThreadCreator> maxThreadSize(int maxThreadSize)
		{
		...
		*/
		...
		public AnycastRequestDispatcherBuilder<Request, Response, RequestThread, RequestThreadCreator> dispatcherWaitTime(long dispatcherWaitTime)
		{
		...
		public AnycastRequestDispatcherBuilder<Request, Response, RequestThread, RequestThreadCreator> idleCheckPeriod(long idleCheckPeriod)
		{
			this.idleCheckPeriod = idleCheckPeriod;
			return this;
		}

		public AnycastRequestDispatcherBuilder<Request, Response, RequestThread, RequestThreadCreator> scheduler(ScheduledThreadPoolExecutor scheduler)
		{
			this.scheduler = scheduler;
			return this;
		}
		
		public AnycastRequestDispatcherBuilder<Request, Response, RequestThread, RequestThreadCreator> clientPool(FreeClientPool pool)
		{
			this.clientPool = pool;
			return this;
		}
		
		public AnycastRequestDispatcherBuilder<Request, Response, RequestThread, RequestThreadCreator> serverAddress(String serverAddress)
		{
			this.serverAddress = serverAddress;
			return this;
		}

		public AnycastRequestDispatcherBuilder<Request, Response, RequestThread, RequestThreadCreator> serverPort(int serverPort)
		{
			this.serverPort = serverPort;
			return this;
		}

		public AnycastRequestDispatcherBuilder<Request, Response, RequestThread, RequestThreadCreator> threadCreator(RequestThreadCreator threadCreator)
		{
			this.threadCreator = threadCreator;
			return this;
		}
		...
		/*
		public AnycastRequestDispatcherBuilder<Request, Response, RequestThread, RequestThreadCreator> timeout(long timeout)
		{
		...
		*/
		...
		@Override
		public AnycastRequestDispatcher<Request, Response, RequestThread, RequestThreadCreator> build()
		{
			return new AnycastRequestDispatcher<Request, Response, RequestThread, RequestThreadCreator>(this);
		}
...
//					// If the request is dequeued before the thread is available, it is possible the dequeued notification is lost without being assigned to any threads. 04/20/2018, Bing Li
