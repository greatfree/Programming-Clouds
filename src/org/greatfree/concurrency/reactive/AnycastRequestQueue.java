...
/*
 * The thread is the base one to support implementing anycast requests in a concurrent way. 11/29/2014, Bing Li
 */

// Created: 11/29/2014, Bing Li
// public abstract class AnycastRequestQueue<Request extends AnycastRequest, Response extends AnycastResponse> implements Runnable, Comparable<AnycastRequestQueue<Request, Response>>
public abstract class AnycastRequestQueue<Request extends AnycastRequest, Response extends AnycastResponse> extends RunnerTask
{
	...
	// The IP/port of the anycast original initiator. The response must be sent back to it. 11/29/2014, Bing Li
	...
	// The TCP client pool. With it, it is able to get the instance of the client to connect the initiator of the anycast. 11/29/2014, Bing Li
	 ...
	 */
	public AnycastRequestQueue(IPResource ipPort, FreeClientPool pool)
	{
	 ...
	 * Initialize an instance. 11/29/2014, Bing Li
	 */
	public AnycastRequestQueue(IPResource ipPort, FreeClientPool pool, int taskSize)
	{
		this.key = Tools.generateUniqueKey();
		this.queue = new LinkedBlockingQueue<Request>();
		this.ipPort = ipPort;
...
//	public int getQueueSize()
	...
	/*
	@Override
	public int compareTo(AnycastRequestQueue<Request, Response> obj)
	{
		if (obj != null)
		{
