...
//	private String key;
	...
	private ThreadIdleChecker<OldBoundNotificationDispatcher<Notification, Binder, NotificationThread, ThreadCreator>> idleChecker;
	
	/*
	 * When a server dispatcher has a local thread pool for each message dispatcher, the constructor is used. 11/26/2013, Bing Li
	 */
	/*
	public OldBoundNotificationDispatcher(int poolSize, long keepAliveTime, Binder binder, ThreadCreator threadCreator, int maxTaskSize, int maxThreadSize, long dispatcherWaitTime, int waitRound, long idleCheckDelay, long idleCheckPeriod, ScheduledThreadPoolExecutor scheduler, long timeout)
	{
	...
	*/
	 ...
	 */
	/*
	public OldBoundNotificationDispatcher(ThreadPool threadPool, Binder binder, ThreadCreator threadCreator, int maxTaskSize, int maxThreadSize, long dispatcherWaitTime, int waitRound, long idleCheckDelay, long idleCheckPeriod, ScheduledThreadPoolExecutor scheduler, long timeout)
	{
	...
	*/
	...
	public OldBoundNotificationDispatcher(BoundNotificationDispatcherBuilder<Notification, Binder, NotificationThread, ThreadCreator> builder)
	{
...
//		super(builder.getThreadPool(), builder.getMaxTaskSize(), builder.getScheduler(), builder.getDispatcherWaitTime(), builder.getIdleCheckDelay(), builder.getIdleCheckPeriod(), builder.getWaitRound());
	...
	public static class BoundNotificationDispatcherBuilder<Notification extends ServerMulticastMessage, Binder extends MessageBindable<Notification>, NotificationThread extends BoundNotificationQueue<Notification, Binder>, ThreadCreator extends BoundNotificationThreadCreatable<Notification, Binder, NotificationThread>> implements Builder<OldBoundNotificationDispatcher<Notification, Binder, NotificationThread, ThreadCreator>>
	{
...
//		private long timeout;
		...
		*/
		...
		@Override
		public OldBoundNotificationDispatcher<Notification, Binder, NotificationThread, ThreadCreator> build()
		{
			return new OldBoundNotificationDispatcher<Notification, Binder, NotificationThread, ThreadCreator>(this);
		}
