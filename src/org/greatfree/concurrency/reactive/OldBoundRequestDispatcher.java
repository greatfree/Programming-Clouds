...
// public class OldBoundRequestDispatcher<Request extends ServerMulticastMessage, Response extends ServerMessage, RequestBinder extends MessageBindable<Request>, RequestThread extends BoundRequestQueue<Request, Response, RequestBinder>, RequestThreadCreator extends BoundBroadcastRequestThreadCreatable<Request, Response, RequestBinder, RequestThread>> extends ConcurrentDispatcher implements Runnable, CheckIdleable
public class OldBoundRequestDispatcher<Request extends ServerMulticastMessage, Response extends ServerMessage, RequestBinder extends MessageBindable<Request>, RequestThread extends BoundRequestQueue<Request, Response, RequestBinder>, RequestThreadCreator extends BoundBroadcastRequestThreadCreatable<Request, Response, RequestBinder, RequestThread>> extends ConcurrentDispatcher
{
	...
	private IPResource rootAddress;
	...
	private ThreadIdleChecker<OldBoundRequestDispatcher<Request, Response, RequestBinder, RequestThread, RequestThreadCreator>> idleChecker;
	 ...
	 */
	/*
	public OldBoundRequestDispatcher(FreeClientPool pool, String rootIP, int rootPort, int threadPoolSize, long keepAliveTime, RequestBinder reqBinder, RequestThreadCreator threadCreator, int maxTaskSize, long dispatcherWaitTime, int waitRound, long idleCheckDelay, long idleCheckPeriod, ScheduledThreadPoolExecutor scheduler, long timeout)
	{
		super(threadPoolSize, keepAliveTime, maxTaskSize, scheduler, dispatcherWaitTime, true, idleCheckDelay, idleCheckPeriod, waitRound, timeout);
		this.clientPool = pool;
		this.rootAddress = new IPPort(rootIP, rootPort);
		this.threads = new ConcurrentHashMap<String, RequestThread>();
		this.requestQueue = new LinkedBlockingQueue<Request>();
		this.threadCreator = threadCreator;
		this.idleChecker = new ThreadIdleChecker<OldBoundRequestDispatcher<Request, Response, RequestBinder, RequestThread, RequestThreadCreator>>(this);
	...
	*/
	 ...
	 */
	/*
	public OldBoundRequestDispatcher(FreeClientPool pool, String rootIP, int rootPort, ThreadPool threadPool, RequestBinder reqBinder, RequestThreadCreator threadCreator, int maxTaskSize, int maxThreadSize, long dispatcherWaitTime, int waitRound, long idleCheckDelay, long idleCheckPeriod, ScheduledThreadPoolExecutor scheduler, long timeout)
	{
	...
	*/
	...
	public OldBoundRequestDispatcher(BoundRequestDispatcherBuilder<Request, Response, RequestBinder, RequestThread, RequestThreadCreator> builder)
	{
...
//		super(builder.getThreadPoolSize(), builder.getMaxTaskSize(), builder.getScheduler(), builder.getDispatcherWaitTime(), builder.getIdleCheckDelay(), builder.getIdleCheckPeriod(), builder.getWaitRound());
		super(builder.getThreadPoolSize(), builder.getMaxTaskSize(), builder.getScheduler(), builder.getDispatcherWaitTime(), builder.getIdleCheckDelay(), builder.getIdleCheckPeriod());
		this.clientPool = builder.getClientPool();
		this.rootAddress = new IPResource(builder.getRootIP(), builder.getRootPort());
	...
	public static class BoundRequestDispatcherBuilder<Request extends ServerMulticastMessage, Response extends ServerMessage, RequestBinder extends MessageBindable<Request>, RequestThread extends BoundRequestQueue<Request, Response, RequestBinder>, RequestThreadCreator extends BoundBroadcastRequestThreadCreatable<Request, Response, RequestBinder, RequestThread>> implements Builder<OldBoundRequestDispatcher<Request, Response, RequestBinder, RequestThread, RequestThreadCreator>>
	{
		private FreeClientPool clientPool;
...
//		private long timeout;
		...
		public BoundRequestDispatcherBuilder<Request, Response, RequestBinder, RequestThread, RequestThreadCreator> clientPool(FreeClientPool pool)
		{
			this.clientPool = pool;
			return this;
		}
		...
		*/
		...
		public BoundRequestDispatcherBuilder<Request, Response, RequestBinder, RequestThread, RequestThreadCreator> poolSize(int threadPoolSize)
		{
		...
		*/
		...
		@Override
		public OldBoundRequestDispatcher<Request, Response, RequestBinder, RequestThread, RequestThreadCreator> build()
		{
			return new OldBoundRequestDispatcher<Request, Response, RequestBinder, RequestThread, RequestThreadCreator>(this);
		}
...
//	private synchronized boolean createThread(Request request, int upperSize)
	private synchronized boolean createThread(int upperSize)
	{
		...
		if (this.threads.size() < upperSize)
		{
			...
			RequestThread thread = this.threadCreator.createRequestThreadInstance(this.rootAddress, this.clientPool, this.getMaxTaskSizePerThread(), this.getServerKey(), this.reqBinder);
