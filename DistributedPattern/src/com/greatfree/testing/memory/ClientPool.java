...
/*
 * The pool is responsible for creating and managing instance of FreeClient to achieve the goal of using as small number of instances of FreeClient to send messages to the coordinator in a high performance. 11/28/2014, Bing Li
 */
...
public class ClientPool
{
	...
	/*
	 * Initialize the client pool. The method is called when the crawler process is started. 11/28/2014, Bing Li
	 */
	public void init()
	{
