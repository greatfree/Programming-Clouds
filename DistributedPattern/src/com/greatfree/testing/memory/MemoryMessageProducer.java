...
{
	private Threader<MessageProducer<MemoryDispatcher>, MemoryMessageProducerDisposer> producerThreader;
	...
	public void Init()
	{
		...
		this.producerThreader = new Threader<MessageProducer<MemoryDispatcher>, MemoryMessageProducerDisposer>(new MessageProducer<MemoryDispatcher>(new MemoryDispatcher(ServerConfig.DISPATCHER_POOL_SIZE, ServerConfig.DISPATCHER_POOL_THREAD_POOL_ALIVE_TIME)), new MemoryMessageProducerDisposer());
