...
{
	/*
	 * Initialize the server IO. The socket is the connection between the crawler and the coordinator. The collaborator is shared with other IOs to control the count of ServerIOs instances. 11/27/2014, Bing Li
	 */
