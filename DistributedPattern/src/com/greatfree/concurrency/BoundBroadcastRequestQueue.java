...
public class BoundBroadcastRequestQueue<Request extends BroadcastRequest, Response extends BroadcastResponse, RequestBinder extends MessageBindable<Request>> extends Thread
{
	 ...
	 */
	public BoundBroadcastRequestQueue(IPPort ipPort, FreeClientPool pool, String dispatcherKey, RequestBinder reqBinder)
	{
	 ...
	 * Initialize an instance. 11/29/2014, Bing Li
	 */
	public BoundBroadcastRequestQueue(IPPort ipPort, FreeClientPool pool, int taskSize, String dispatcherKey, RequestBinder reqBinder)
	{
		this.key = Tools.generateUniqueKey();
		this.queue = new LinkedBlockingQueue<Request>();
		this.ipPort = ipPort;
