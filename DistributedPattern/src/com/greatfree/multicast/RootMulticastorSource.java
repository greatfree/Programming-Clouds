...
/*
 * The class contains all of the information that is required to create an instance fo RootObjectMulticastor. It is needed in the relevant pool. 11/26/2014, Bing Li
 */

// Created: 11/26/2014, Bing Li
public class RootMulticastorSource<Source extends Serializable, MultiMessage extends ServerMulticastMessage, MessageCreator extends ObjectMulticastCreatable<MultiMessage, Source>>
{
