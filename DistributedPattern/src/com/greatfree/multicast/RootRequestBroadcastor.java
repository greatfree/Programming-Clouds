...
public class RootRequestBroadcastor<MessagedRequestData extends Serializable, Request extends BroadcastRequest, Response extends BroadcastResponse, RequestCreator extends RootBroadcastRequestCreatable<Request, MessagedRequestData>> extends HashFreeObject
{
	...
	public Map<String, Response> disseminate(MessagedRequestData messagedData) throws InterruptedException, InstantiationException, IllegalAccessException, IOException
	{
		...
		if (this.clientPool.getClientSize() > this.rootBranchCount)
		{
			...
			tree = Tree.constructTree(UtilConfig.ROOT_KEY, new LinkedList<String>(this.clientPool.getNodeKeys()), this.rootBranchCount, this.treeBranchCount);
