...
public class RootObjectMulticastor<ObjectedData extends Serializable, Message extends ServerMulticastMessage, MessageCreator extends ObjectMulticastCreatable<Message, ObjectedData>> extends HashFreeObject
{
